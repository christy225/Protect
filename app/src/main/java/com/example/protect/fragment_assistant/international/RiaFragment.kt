...
class RiaFragment(private val context: MainActivity) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_assistant_operation_ria, container, false)
        ...
        buttonUpload = view.findViewById(R.id.button_upload_image_ria_transaction)

        buttonRegister = view.findViewById(R.id.btn_register_input_ria)
        progressBar = view.findViewById(R.id.progressBar_input_ria)

        val link1 = view.findViewById<ImageView>(R.id.assistant_link1_ria)
        val link2 = view.findViewById<ImageView>(R.id.assistant_link2_ria)
